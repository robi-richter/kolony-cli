...
program
  ...
  .arguments('<aName> <cName> <mName>')
  .action(function (aName, cName, mName) {
     apiName = aName;
...
projectController.moduleController.createApi(apiName, controllerName, modelName, function(error){
  if (error){
    console.log(error);
  }
});
